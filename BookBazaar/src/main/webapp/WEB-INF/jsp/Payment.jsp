...
<div class="headingWrap">
								<h1 class="headingTop text-center">Select Your Payment Method</h1>	
								<p class="text-center">Please Choose Your Method </p>
						</div>
<br/>
<br/>
<br/>						
<center>
<font size="5" face="Algerian"><sf:radiobutton path="paymentMode" value="DEBIT"/>DEBIT CARD
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
					            ...
					            <label class="btn paymentMethod">
					             ...
					             <label class="btn paymentMethod">
					                ...
					                <input type="radio" name="options" name="_eventId_event2"> 
					            </label>
					            <label class="btn paymentMethod">
...
<br/>
<br/>
    <center><input type="submit" value="NEXT" class="btn btn-lg btn-primary"  name="_eventId_event2"></input></center>
